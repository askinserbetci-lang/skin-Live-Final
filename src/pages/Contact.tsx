        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-paper/60 font-light text-lg md:text-2xl leading-relaxed max-w-3xl mx-auto">
              Connect with Studio Aşkın for inquiries, collaborations, and press.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="bg-white/5 border border-white/10 p-10 rounded-sm hover:border-gold/30 transition-colors duration-500 text-center">
              ...
              <div className="flex justify-center gap-6">
                ...
                <a href="https://www.facebook.com/studioaskin" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-white transition-colors">
                  Facebook
                </a>
              </div>
            </div>
